...
//
function RPC_Model(schemaName, schemaJSON)
{
...
RPC_Model.prototype.register       =  function(method, params, id, callbacks)
{	
	new Request(method, params, id, callbacks);
};

RPC_Model.prototype.registerInsert =  function(callbacks)
{
...
RPC_Model.prototype.registerGet    =  function(callbacks)
{
...
RPC_Model.prototype.registerSet    =  function(callbacks)
{
...
RPC_Model.prototype.registerDel    =  function(callbacks)
{
...
//
RPC_Model.ObjectId         =  ObjectId;
RPC_Model.Email            =  Email;
RPC_Model.Session          =  Session;
RPC_Model.Schema           =  Schema;
module.exports =  exports  =  RPC_Model;